...
export const personalData = {
  ...
  heroTitle: "Crafting Intelligent Web Experiences.",
  heroSubtitle: "A full-stack developer transforming ideas into reality with modern web technologies and a passion for machine learning.",
  aboutTitle: "I build robust web applications and explore the frontiers of AI.",
